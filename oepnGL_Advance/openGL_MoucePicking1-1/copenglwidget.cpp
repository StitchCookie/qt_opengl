...
void COpenGlWidget::initializeGL()
{
    ...
    m_boxTex = new QOpenGLTexture(QImage(":/container2.png").mirrored());
    m_planeTex = new QOpenGLTexture(QImage(":/container2_specular.png").mirrored());

    m_CubeMesh = processMesh(cubeVertices,36,m_boxTex->textureId());
...
void COpenGlWidget::paintGL()
{
    ...
    case Rect:
        ...
        m_CubeMesh->Draw(shaderProgramObject);
